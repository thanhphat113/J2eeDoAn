                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form class="input-group mb-3" action="qlac" method="get">
                                        ...
                                        <button name="action"  type="submit">Tìm kiếm</button>
                                    </form>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="qlac" method="post">
                                                ...
                                                <button type="submit" name="action" class="test"><i class="fas fa-plus"></i>
                                                    update</button>
                                            </form>
                                        </td>
                                        <td>
                                            <form action="deleteAc" method="post">
                                                <input type="hidden" name="id" value="${account.userID}">  
                                                <button type="submit" name="action"  class="test"><i
